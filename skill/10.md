...
Invest the time to build a single HTML template that carries the bulk of the 
HTML logic.  Extend this templates to define pages that provide custom data
...
"theme" template.  Use this them in all other pages to create a standard
